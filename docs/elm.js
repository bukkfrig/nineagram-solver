...
var $author$project$Main$CreatingPuzzle = function (a) {
	return {$: 0, a: a};
};
var $author$project$Main$init = $author$project$Main$CreatingPuzzle(
	{j: ''});
...
var $author$project$Main$SolvingPuzzle = function (a) {
	return {$: 1, a: a};
};
var $author$project$Main$backspace = 8;
...
var $author$project$Nineagram$fromCharList = function (letters) {
	var lowerCaseLetters = A2($elm$core$List$map, $elm$core$Char$toLower, letters);
	return (A2($elm$core$List$all, $elm$core$Char$isAlpha, letters) && ($elm$core$List$length(letters) === 9)) ? $elm$core$Maybe$Just(lowerCaseLetters) : $elm$core$Maybe$Nothing;
};
...
var $author$project$Nineagram$fromString = function (letters) {
	return $author$project$Nineagram$fromCharList(
		$elm$core$String$toList(letters));
};
var $author$project$Main$initSolving = function (puzzle) {
	return {H: false, t: _List_Nil, I: puzzle, z: ''};
};
...
var $author$project$Main$updateCreating = F2(
	function (msg, model) {
		var enter = 13;
		var _char = msg;
		if ($elm$core$Char$isAlpha(_char)) {
			return $author$project$Main$CreatingPuzzle(
				_Utils_update(
					model,
					{
						j: $elm$core$String$fromList(
							_Utils_ap(
								$elm$core$String$toList(model.j),
								_List_fromArray(
									[_char])))
					}));
		} else {
					...
					_Utils_update(
						model,
						{
							j: $elm$core$String$fromList(
								A2(
									$elm$core$List$take,
									$elm$core$String$length(model.j) - 1,
									$elm$core$String$toList(model.j)))
						}));
			} else {
				if (_Utils_eq(
					$elm$core$Char$toCode(_char),
					enter)) {
					var maybePuzzle = $author$project$Nineagram$fromString(model.j);
					if (!maybePuzzle.$) {
						var puzzle = maybePuzzle.a;
						return $author$project$Main$SolvingPuzzle(
							$author$project$Main$initSolving(puzzle));
					} else {
						return $author$project$Main$CreatingPuzzle(model);
					}
				} else {
					return $author$project$Main$CreatingPuzzle(model);
				}
...
var $author$project$Nineagram$guessToString = function (_v0) {
	var s = _v0;
	return s;
};
var $elm$core$Basics$neq = _Utils_notEqual;
var $author$project$Main$updateSolving = F2(
	function (msg, model) {
		switch (msg.$) {
			case 0:
				var typing = msg.a;
				return $author$project$Main$SolvingPuzzle(
					_Utils_update(
						...
						{z: typing}));
			case 1:
				var maybeGuess = msg.a;
				if (maybeGuess.$ === 1) {
					return $author$project$Main$SolvingPuzzle(model);
				} else {
					var guess = maybeGuess.a;
					return $author$project$Main$SolvingPuzzle(
						_Utils_update(
							model,
							{
					...
					_Utils_update(
						model,
						{
							t: A2(
								...
								function (g) {
									return !_Utils_eq(
										$author$project$Nineagram$guessToString(guess),
										$author$project$Nineagram$guessToString(g));
								},
								model.t)
						}));
			default:
...
var $author$project$Main$update = F2(
	function (msg, model) {
		...
		if (!_v0.a.$) {
			if (!_v0.b.$) {
				var creatingMsg = _v0.a.a;
				var creatingModel = _v0.b.a;
				return A2($author$project$Main$updateCreating, creatingMsg, creatingModel);
			} else {
				return model;
			}
		} else {
			if (_v0.b.$ === 1) {
				var solvingMsg = _v0.a.a;
				var solvingModel = _v0.b.a;
				return A2($author$project$Main$updateSolving, solvingMsg, solvingModel);
			} else {
				return model;
			}
		}
	});
var $author$project$Main$CreatingMsg = function (a) {
	return {$: 0, a: a};
};
var $author$project$Main$SolvingMsg = function (a) {
	return {$: 1, a: a};
};
var $elm$virtual_dom$VirtualDom$map = _VirtualDom_map;
var $elm$html$Html$map = $elm$virtual_dom$VirtualDom$map;
var $author$project$Main$Keyed = $elm$core$Basics$identity;
...
var $author$project$Main$getChar = F2(
	function (msgConstructor, code) {
...
var $author$project$Main$viewCreating = function (model) {
	var letters = function () {
		...
		if (_v0 === '') {
			...
			return $elm$core$String$toList(model.j);
		}
	}();
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
				...
				A2(
					...
					$author$project$Main$getChar($elm$core$Basics$identity),
...
var $author$project$Main$EnableCheat = {$: 3};
var $author$project$Main$SubmitGuess = function (a) {
	return {$: 1, a: a};
};
...
var $author$project$Main$onEnter = function (msg) {
	var succeedIfEnter = F2(
		function (a, code) {
			var enter = 13;
			return _Utils_eq(code, enter) ? $elm$json$Json$Decode$succeed(a) : $elm$json$Json$Decode$fail('not ENTER');
		});
	var keyCodeDecoder = $elm$html$Html$Events$keyCode;
	return A2(
		$elm$html$Html$Events$on,
		'keydown',
		A2(
...
var $author$project$Nineagram$Guess = $elm$core$Basics$identity;
var $elm$core$String$toLower = _String_toLower;
var $author$project$Nineagram$stringToGuess = function (guess) {
	var lowerCaseGuess = $elm$core$String$toLower(guess);
	return ($elm$core$String$length(guess) === 5) ? $elm$core$Maybe$Just(lowerCaseGuess) : $elm$core$Maybe$Nothing;
};
...
var $author$project$Nineagram$isValidGuess = F2(
	function (nineagram, guess) {
		if ($elm$core$String$length(
			$author$project$Nineagram$guessToString(guess)) !== 5) {
			return false;
		} else {
...
var $author$project$Nineagram$getMiddleLetter = function (_v0) {
	var guess = _v0;
	return A2(
		$elm$core$List$drop,
		2,
			...
			if (_v1.$ === 1) {
				...
				var _v2 = A2(
					...
					$author$project$Nineagram$removeMiddleLetter(
						$elm$core$String$toList(
							$author$project$Nineagram$guessToString(otherGuess))));
				if (_v2.$ === 1) {
					return false;
				} else {
					if (!_v2.a.b) {
		...
		var viewSolutionsForGuess = function (guess) {
			return (isValid(guess) && hasSolutions(guess)) ? A2(
				...
				_List_fromArray(
					[
						$elm$html$Html$text(
						$author$project$Nineagram$guessToString(guess) + (' (' + (A2(
							$elm$core$String$join,
							', ',
							A2(
								$elm$core$List$map,
								$author$project$Nineagram$guessToString,
								solutions(guess))) + ')')))
					])) : $elm$html$Html$text('');
		};
		return A2(
...
var $author$project$Main$viewCheatSolutions = function (puzzle) {
	var cheatGuesses = A2(
		...
		A2($elm$core$List$filterMap, $author$project$Nineagram$stringToGuess, $author$project$Cheat$cheatWords));
	return A2($author$project$Main$viewSolutions, puzzle, cheatGuesses);
};
var $author$project$Main$DeleteGuess = function (a) {
	return {$: 2, a: a};
};
...
var $author$project$Main$viewNineagram = F2(
	function (puzzle, currentGuess) {
		var remain = function () {
			var _v0 = A2($author$project$Nineagram$remainingLetters, puzzle, currentGuess);
			if (!_v0.$) {
				var r = _v0.a;
				return r;
			} else {
							...
							_Utils_ap(
								A2(
									...
									$elm$core$String$length(
										$author$project$Nineagram$guessToString(currentGuess)),
									' '),
								remain)))));
		};
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$elm$html$Html$Attributes$class('delete-icon'),
							$elm$html$Html$Events$onClick(
							$author$project$Main$DeleteGuess(currentGuess))
						]),
					_List_fromArray(
						[
							A2(
							...
							_List_fromArray(
								[
									...
									_List_fromArray(
										[
											$elm$html$Html$Attributes$src('trash-can.svg')
										]),
									_List_Nil)
								]))
						])),
...
var $author$project$Main$viewSolving = function (model) {
	var cheatButton = A2(
			...
			[
				...
				_List_fromArray(
					[
						...
						$author$project$Main$SubmitGuess(
							$author$project$Nineagram$stringToGuess(model.z)))
					]),
				_List_fromArray(
					[
						A2(
				...
				A2(
					$elm$core$List$map,
					$author$project$Main$viewNineagram(model.I),
					model.t)),
				A2(
				$elm$html$Html$div,
				_List_fromArray(
				...
				_List_fromArray(
					[
						...
						model.H ? A2($elm$html$Html$Lazy$lazy, $author$project$Main$viewCheatSolutions, model.I) : cheatButton
					]))
			]));
};
var $author$project$Main$view = function (model) {
	if (!model.$) {
		var creatingModel = model.a;
		return A2(
			$elm$html$Html$map,
			$author$project$Main$CreatingMsg,
			$author$project$Main$viewCreating(creatingModel));
	} else {
		var solvingModel = model.a;
		return A2(
			$elm$html$Html$map,
			$author$project$Main$SolvingMsg,
			$author$project$Main$viewSolving(solvingModel));
	}
};
